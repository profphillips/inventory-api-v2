...
// This api runs on Heroku and connects to the free MongoDb Atlas cloud.
// Heroku stores the secret login info.
...
const DATABASE_NAME = "inventory-v2";
...
app.listen(port, () => {
  ...
  // UPDATE ------------------------------------------------------------------
  // ***** Update the document from the db given a Mongo ID *****
...
// 2. Used google account to log into MongoDB/Atlas and added new collection onto db.
// 3. Store the Mongodb connection string with user/password on Heroku Settings /
//    Reveal Config Vars and then key of MONGODB_URI and value of connection string
// 4. Heroku: click More / View logs to see errors as you test api from postman
// 5. Heroku: click Activity / View build log to see any issues
// ---------------------------------------------------------------------------
